...
/// surfaces, one lime accent, Space Grotesk and JetBrains Mono. Dark is the
/// design; light is a paper variant where the accent is a fill with dark ink on
/// it. The docs app under /docs uses the same `--af-*` tokens (see
/// `docs_app/app/global.css`), so the two read as one site.
library;
...
const accent2Color = Color.variable('--af-accent-2');
