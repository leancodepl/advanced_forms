...
class Hero extends StatelessComponent {
  ...
  static List<StyleRule> get _layout => [
    ...
    css('.af-hero-bg').styles(
      ...
      raw: {
        'inset': '0',
        'background': _glow(
          'rgba(237, 255, 47, 0.55)',
          'rgba(237, 255, 47, 0.25)',
          'rgba(11, 11, 13, 0.06)',
        ),
    ...
    css('.dark .af-hero-bg').styles(
      raw: {
        'background': _glow(
          'rgba(237, 255, 47, 0.16)',
          'rgba(237, 255, 47, 0.07)',
          'rgba(237, 255, 47, 0.09)',
        ),
      },
    ),
    css(
  ...
  static List<StyleRule> get _install => [
    ...
    ).styles(color: textColor, raw: {'border-color': accent2Color.value}),
